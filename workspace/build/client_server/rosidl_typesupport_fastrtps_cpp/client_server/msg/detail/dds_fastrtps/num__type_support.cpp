...
#include "client_server/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const client_server::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<client_server::msg::Num *>(
    untyped_ros_message);
...
{
  return &client_server::msg::typesupport_fastrtps_cpp::_Num__handle;
}
