...
client_server__msg__Num__create()
{
  ...
  client_server__msg__Num * msg = (client_server__msg__Num *)allocator.allocate(sizeof(client_server__msg__Num), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(client_server__msg__Num));
  bool success = client_server__msg__Num__init(msg);
  if (!success) {
...
client_server__msg__Num__destroy(client_server__msg__Num * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    client_server__msg__Num__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
client_server__msg__Num__Sequence__init(client_server__msg__Num__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  client_server__msg__Num * data = NULL;

  if (size) {
    data = (client_server__msg__Num *)allocator.zero_allocate(size, sizeof(client_server__msg__Num), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = client_server__msg__Num__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        client_server__msg__Num__fini(&data[i - 1]);
      }
...
client_server__msg__Num__Sequence__fini(client_server__msg__Num__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      client_server__msg__Num__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  client_server__msg__Num__Sequence * array = (client_server__msg__Num__Sequence *)allocator.allocate(sizeof(client_server__msg__Num__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = client_server__msg__Num__Sequence__init(array, size);
  if (!success) {
...
client_server__msg__Num__Sequence__destroy(client_server__msg__Num__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    client_server__msg__Num__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
client_server__msg__Num__Sequence__are_equal(const client_server__msg__Num__Sequence * lhs, const client_server__msg__Num__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!client_server__msg__Num__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  client_server__msg__Num__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(client_server__msg__Num);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    client_server__msg__Num * data =
      (client_server__msg__Num *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!client_server__msg__Num__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          client_server__msg__Num__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!client_server__msg__Num__copy(
